...
if ( ! function_exists( 'upright_setup' ) ) :
	...
	function upright_setup() {
		...
		register_nav_menus( array(
			'primary'   => esc_html__( 'Primary Menu', 'upright' ),
			'secondary' => esc_html__( 'Secondary Menu', 'upright' ),
			'footer'    => esc_html__( 'Footer Menu', 'upright' ),
		) );
...
function upright_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'upright' ),
		'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Header Sidebar', 'upright' ),
		'id'            => 'sidebar-header',
