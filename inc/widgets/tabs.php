...
class Upright_Widget_Tabs extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'upright_tabs', esc_html__( 'Upright - Tabs', 'upright' ), array(
			'classname'   => 'tabs-widget',
			'description' => esc_html__( 'Displays recent posts, comments, categories etc in multiple tabs.', 'upright' )
		) );
	}
	...
	public function widget( $args, $instance ) {
		...
		$tab[1] = apply_filters( 'widget_title', esc_html__( 'Recent', 'upright' ) );
		$tab[2] = apply_filters( 'widget_title', esc_html__( 'Comments', 'upright' ) );
		$tab[3] = apply_filters( 'widget_title', esc_html__( 'Tags', 'upright' ) );
		$tab[4] = apply_filters( 'widget_title', esc_html__( 'Popular', 'upright' ) );
		$tab[5] = apply_filters( 'widget_title', esc_html__( 'Categories', 'upright' ) );
		$tab[6] = apply_filters( 'widget_title', esc_html__( 'Archives', 'upright' ) );
		$tab[7] = apply_filters( 'widget_title', esc_html__( 'Pages', 'upright' ) );
	...
	public function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_one_title' ) ); ?>"><?php esc_html_e( 'Tab One Title:', 'upright' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_one' ) ); ?>"><?php esc_html_e( 'Tab One Content:', 'upright' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_one' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_one ); ?>><?php esc_html_e( 'Recent Posts', 'upright' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_one ); ?>><?php esc_html_e( 'Recent Comments', 'upright' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_one ); ?>><?php esc_html_e( 'Tag Clouds', 'upright' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_one ); ?>><?php esc_html_e( 'Popular Posts', 'upright' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_one ); ?>><?php esc_html_e( 'Categories', 'upright' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_one ); ?>><?php esc_html_e( 'Archives', 'upright' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_one ); ?>><?php esc_html_e( 'Pages', 'upright' ); ?></option>
			</select>
		</p>
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_two_title' ) ); ?>"><?php esc_html_e( 'Tab Two Title:', 'upright' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_two' ) ); ?>"><?php esc_html_e( 'Tab Two Content:', 'upright' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_two' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_two ); ?>><?php esc_html_e( 'Recent Posts', 'upright' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_two ); ?>><?php esc_html_e( 'Recent Comments', 'upright' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_two ); ?>><?php esc_html_e( 'Tag Clouds', 'upright' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_two ); ?>><?php esc_html_e( 'Popular Posts', 'upright' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_two ); ?>><?php esc_html_e( 'Categories', 'upright' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_two ); ?>><?php esc_html_e( 'Archives', 'upright' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_two ); ?>><?php esc_html_e( 'Pages', 'upright' ); ?></option>
			</select>
		</p>
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_three_title' ) ); ?>"><?php esc_html_e( 'Tab Three Title:', 'upright' ); ?></label><br/>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'widget_three' ) ); ?>"><?php esc_html_e( 'Tab Three Content:', 'upright' ); ?></label><br/>
			<select id="<?php echo esc_attr( $this->get_field_id( 'widget_three' ) ); ?>"
				...
				<option
					value="1" <?php selected( 1, $widget_three ); ?>><?php esc_html_e( 'Recent Posts', 'upright' ); ?></option>
				<option
					value="2" <?php selected( 2, $widget_three ); ?>><?php esc_html_e( 'Recent Comments', 'upright' ); ?></option>
				<option
					value="3" <?php selected( 3, $widget_three ); ?>><?php esc_html_e( 'Tag Clouds', 'upright' ); ?></option>
				<option
					value="4" <?php selected( 4, $widget_three ); ?>><?php esc_html_e( 'Popular Posts', 'upright' ); ?></option>
				<option
					value="5" <?php selected( 5, $widget_three ); ?>><?php esc_html_e( 'Categories', 'upright' ); ?></option>
				<option
					value="6" <?php selected( 6, $widget_three ); ?>><?php esc_html_e( 'Archives', 'upright' ); ?></option>
				<option
					value="7" <?php selected( 7, $widget_three ); ?>><?php esc_html_e( 'Pages', 'upright' ); ?></option>
			</select>
		</p>
