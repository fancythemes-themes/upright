...
function upright_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'colors' )->title              = esc_html__( 'Background & Sidebar Colors', 'upright' );
	...
	$wp_customize->add_section( 'featured_post_slider', array(
		'title'    => esc_html__( 'Featured Post Slider Options', 'upright' ),
		'priority' => 31,
	) );
	...
	$wp_customize->add_section( 'featured_post_carousel', array(
		'title'    => esc_html__( 'Featured Post Carousel Options', 'upright' ),
		'priority' => 32,
	) );
	...
	$wp_customize->add_section( 'footer', array(
		'title'    => esc_html__( 'Footer Setting', 'upright' ),
		'priority' => 42,
	) );
	...
	$wp_customize->add_section( 'layout', array(
		'title'    => esc_html__( 'Layout Setting', 'upright' ),
		'priority' => 34,
	) );
	...
	$wp_customize->add_section( 'menu_colors', array(
		'title'    => esc_html__( 'Top Menu Colors', 'upright' ),
		'priority' => 36,
	) );
	...
	$wp_customize->add_section( 'secondary_menu_colors', array(
		'title'    => esc_html__( 'Secondary Menu Colors', 'upright' ),
		'priority' => 37,
	) );
	...
	$wp_customize->add_section( 'content_colors', array(
		'title'    => esc_html__( 'Main Content Colors', 'upright' ),
		'priority' => 38,
	) );
	...
	$wp_customize->add_section( 'typography', array(
		'title'    => esc_html__( 'Typography Setting', 'upright' ),
		'priority' => 39,
	) );
...
function upright_customize_items( $settings = array() ) {
	...
	$settings[] = array(
		'id'                   => 'enable_slider',
		'default'              => false,
		'label'                => esc_html__( 'Enable slider on homepage', 'upright' ),
	...
	$settings[] = array(
		'id'                => 'slider_category',
		'default'           => '',
		'label'             => esc_html__( 'Select the category for slider', 'upright' ),
		'section'           => 'featured_post_slider',
		'priority'          => 2,
		'control'           => 'select',
	...
	$settings[] = array(
		...
		'default'           => 5,
		'label'             => esc_html__( 'Select the maximum post number', 'upright' ),
		'section'           => 'featured_post_slider',
		'priority'          => 3,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		'id'                   => 'slider_auto',
		'default'              => false,
		'label'                => esc_html__( 'Enable auto slide', 'upright' ),
		'section'              => 'featured_post_slider',
		'priority'             => 4,
		'control'              => 'checkbox',
		'sanitize_callback'    => 'upright_sanitize_checkbox',
	...
	$settings[] = array(
		...
		'default'           => 5,
		'label'             => esc_html__( 'Auto slide timer', 'upright' ),
		'section'           => 'featured_post_slider',
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
		'priority'          => 5,
	...
	$settings[] = array(
		'id'                   => 'slider_hide_next',
		'default'              => false,
		'label'                => esc_html__( 'Hide slider in second page and next', 'upright' ),
		'section'              => 'featured_post_slider',
		'priority'             => 6,
		'control'              => 'checkbox',
		'sanitize_callback'    => 'upright_sanitize_checkbox',
	...
	$settings[] = array(
		'id'                   => 'enable_carousel',
		'default'              => false,
		'label'                => esc_html__( 'Enable carousel on homepage', 'upright' ),
	...
	$settings[] = array(
		...
		'default'           => '',
		'label'             => esc_html__( 'Select the category for carousel', 'upright' ),
		'section'           => 'featured_post_carousel',
		'priority'          => 2,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'default'              => false,
		'label'                => esc_html__( 'Hide carousel in second page and next', 'upright' ),
		'section'              => 'featured_post_carousel',
		'priority'             => 6,
		'control'              => 'checkbox',
		'sanitize_callback'    => 'upright_sanitize_checkbox',
	...
	$settings[] = array(
		...
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
		'label'             => esc_html__( 'Do not show posts if home with these categories', 'upright' ),
	...
	$settings[] = array(
		...
		'control'           => 'textarea',
		'sanitize_callback' => 'esc_html',
		'label'             => esc_html__( 'Credit text on footer', 'upright' ),
		'section'           => 'footer',
	);
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'General Layout', 'upright' ),
		'section'           => 'layout',
		'priority'          => 1,
		'control'           => 'radio',
		'sanitize_callback' => 'upright_sanitize_choice',
		'choices'           => array( 'right-sidebar' => esc_html__('Right Sidebar', 'upright'), 'left-sidebar' => esc_html__('Left Sidebar', 'upright') ),
	);
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Post listing layout', 'upright' ),
		'section'           => 'layout',
		'priority'          => 2,
		'control'           => 'radio',
		'sanitize_callback' => 'upright_sanitize_choice',
		'choices'           => array( 'one-column' => esc_html__('One Column', 'upright'), 'two-column' => esc_html__('Two Column', 'upright') ),
	);

	$settings[] = array(
		'id'                   => 'hide_layout_toggle',
		'default'              => false,
		'label'                => esc_html__( 'Do not show layout option', 'upright' ),
		'section'              => 'layout',
		'priority'             => 3,
		'control'              => 'checkbox',
		'sanitize_callback'    => 'upright_sanitize_checkbox',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Recent Posts title in homepage', 'upright' ),
		'section'           => 'layout',
		'priority'          => 4,
		'control'           => 'text',
		'sanitize_callback' => 'esc_html',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Font color', 'upright' ),
		'section'           => 'colors',
		'priority'          => 1,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Link color', 'upright' ),
		'section'           => 'colors',
		'priority'          => 2,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Meta text color', 'upright' ),
		'section'           => 'colors',
		'priority'          => 3,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Border color', 'upright' ),
		'section'           => 'colors',
		'priority'          => 4,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Widget title color', 'upright' ),
		'section'           => 'colors',
		'priority'          => 4,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'transport'         => 'postMessage',
		'label'             => esc_html__( 'Main menu background color', 'upright' ),
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'section'           => 'menu_colors',
		'priority'          => 1,
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main menu link color', 'upright' ),
		'section'           => 'menu_colors',
		'priority'          => 2,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main menu link hover color', 'upright' ),
		'section'           => 'menu_colors',
		'priority'          => 3,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main menu borders color', 'upright' ),
		'section'           => 'menu_colors',
		'priority'          => 4,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Secondary menu link color', 'upright' ),
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Secondary menu link hover color', 'upright' ),
		'section'           => 'secondary_menu_colors',
		'priority'          => 6,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main content background color', 'upright' ),
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main content font color', 'upright' ),
		'section'           => 'content_colors',
		'priority'          => 2,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'transport'         => 'postMessage',
		'label'             => esc_html__( 'Main content link color', 'upright' ),
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'section'           => 'content_colors',
		'priority'          => 3,
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Main content meta text color', 'upright' ),
		'section'           => 'content_colors',
		'priority'          => 4,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Borders color', 'upright' ),
		'section'           => 'content_colors',
		'priority'          => 5,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Section title background color', 'upright' ),
		'section'           => 'content_colors',
		'priority'          => 6,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'control'           => 'color',
		'sanitize_callback' => 'sanitize_hex_color',
		'label'             => esc_html__( 'Section title font color', 'upright' ),
		'section'           => 'content_colors',
		'priority'          => 6,
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Heading Font', 'upright' ),
		'section'           => 'typography',
		'priority'          => 1,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Heading Font Style', 'upright' ),
		'section'           => 'typography',
		'priority'          => 2,
		'control'           => 'radio',
		'sanitize_callback' => 'upright_sanitize_choice',
		'choices'           => array( 'italic' => esc_html__('Italic', 'upright'), 'normal' => esc_html__('Normal', 'upright') ),
		'transport'         => 'postMessage',
		'apply_css'         => array(
			array(
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Heading Font Weight', 'upright' ),
		'section'           => 'typography',
		'priority'          => 3,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Body font', 'upright' ),
		'section'           => 'typography',
		'priority'          => 4,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Menu Font', 'upright' ),
		'section'           => 'typography',
		'priority'          => 7,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Menu Font Style', 'upright' ),
		'section'           => 'typography',
		'priority'          => 8,
		'control'           => 'radio',
		'sanitize_callback' => 'upright_sanitize_choice',
	...
	$settings[] = array(
		...
		'label'             => esc_html__( 'Menu Font Weight', 'upright' ),
		'section'           => 'typography',
		'priority'          => 9,
		'control'           => 'select',
		'sanitize_callback' => 'upright_sanitize_choice',
