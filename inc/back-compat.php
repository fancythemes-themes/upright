...
function upright_upgrade_notice() {
	$message = sprintf(e esc_html__( 'Upright requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'upright' ), $GLOBALS['wp_version'] );
...
function upright_customize() {
	wp_die( sprintf(e esc_html__( 'Upright requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'upright' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function upright_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf(e esc_html__( 'Upright requires at least WordPress version 4.5. You are running version %s. Please upgrade and try again.', 'upright' ), $GLOBALS['wp_version'] ) );
	}
}
