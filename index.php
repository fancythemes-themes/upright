...
get_header(); ?>
	...
	<div id="primary" class="content-area boxed">
		...
		?>
		<h3 class="section-title"><span><?php echo esc_html( upright_get_option( 'recent_post_title', esc_html__( 'Recent Posts', 'upright' ) ) ); ?></span></h3>
		...
		<div id="content" class="site-content group <?php echo esc_attr( $upright_layout_class ); ?>" role="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="layout-toggle group">
					<a class="layout-grid" href="#"><?php esc_html_e( 'Grid', 'upright' ); ?></a>
					<a class="layout-list" href="#"><?php esc_html_e( 'List', 'upright' ); ?></a>
				</div>
